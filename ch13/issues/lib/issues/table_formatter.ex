defmodule Issues.TableFormatter do
  ...
  We calcuate the width of each column to fit the longest element
  in that column.
  """
  ...
  a column, return a list containing the maxmum width of each column

  ## Example
      iex> data = [ ["cata", "wombat", "elk"], ["mongoose", "ant", "gnu"] ]
  ...
  @doc """
  Return a format string that had codes the widths of a set of columns.
  ...
  hypens, with + signs where the vertical bar between the columns goes.
